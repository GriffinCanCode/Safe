...
exports.findUserDuplicates =
  exports.handleDeduplicationOnDelete =
  exports.createDeduplicationReference =
  exports.registerFileHash =
  exports.checkFileExists =
    void 0;
 ...
 */
exports.createDeduplicationReference = functions.https.onCall(
  async (data, context) => {
    try {
      // Ensure user is authenticated
      if (!context.auth) {
