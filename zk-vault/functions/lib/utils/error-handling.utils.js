...
exports.withRetry =
  ...
  exports.withAdvancedErrorHandling =
  exports.getErrorSeverity =
  exports.createErrorResponse =
  exports.mapToFirebaseError =
  exports.ErrorSeverity =
  exports.DataIntegrityError =
...
function mapToFirebaseError(error, context) {
  ...
  // Log the error
  logging_utils_1.logger.logError(
    logging_utils_1.LogCategory.SYSTEM,
  ...
  return async (...args) => {
    ...
    try {
      ...
      if (options.logErrors !== false) {
        ...
        await logging_utils_1.logger.logError(
          logging_utils_1.LogCategory.SYSTEM,
