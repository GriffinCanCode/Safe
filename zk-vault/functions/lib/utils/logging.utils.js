...
exports.logAudit = exports.logSecurity = exports.logError = exports.logWarn = exports.logInfo = exports.logger = exports.StructuredLogger = exports.LogCategory = exports.LogLevel = void 0;
...
const logInfo = (category, message, metadata) => exports.logger.log(LogLevel.INFO, category, message, metadata);
exports.logInfo = logInfo;
const logWarn = (category, message, metadata) => exports.logger.log(LogLevel.WARN, category, message, metadata);
exports.logWarn = logWarn;
const logError = (category, message, error, metadata) => exports.logger.logError(category, message, error, metadata);
exports.logError = logError;
const logSecurity = (message, severity, metadata) => exports.logger.logSecurity(message, severity, metadata);
exports.logSecurity = logSecurity;
const logAudit = (action, message, metadata) => exports.logger.logAudit(action, message, metadata);
