...
exports.getSharedItems =
  exports.shareVaultItem =
  exports.deleteVaultItem =
  exports.getVaultItems =
  exports.createVaultItem =
    void 0;
 ...
 */
exports.createVaultItem = functions.https.onCall(
 ...
 */
exports.getVaultItems = functions.https.onCall(
  (0, error_handler_1.withErrorHandling)(async (data, context) => {
    // Ensure user is authenticated
    if (!context.auth) {
      throw new functions.https.HttpsError(
 ...
 */
exports.deleteVaultItem = functions.https.onCall(
  (0, error_handler_1.withErrorHandling)(async (data, context) => {
    // Ensure user is authenticated
    if (!context.auth) {
      throw new functions.https.HttpsError(
 ...
 */
exports.shareVaultItem = functions.https.onCall(
  (0, error_handler_1.withErrorHandling)(async (data, context) => {
    // Ensure user is authenticated
    if (!context.auth) {
      throw new functions.https.HttpsError(
 ...
 */
exports.getSharedItems = functions.https.onCall(
  (0, error_handler_1.withErrorHandling)(async (data, context) => {
    // Ensure user is authenticated
    if (!context.auth) {
      throw new functions.https.HttpsError(
