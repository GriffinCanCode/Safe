...
describe('Zero-Knowledge Vault', () => {
  ...
  describe('Data Encryption/Decryption', () => {
    ...
    test('should encrypt and decrypt binary data', async () => {
      ...
      const decryptedString = new TextDecoder().decode(decryptResult.data! as unknown as Uint8Array);
...
describe('Password Encryption', () => {
  ...
  describe('Password Encryption/Decryption', () => {
    ...
    test('should fail decryption with wrong key', async () => {
      ...
      const decryptResult = await PasswordEncryption.decryptPasswordItem(encryptResult.data!, wrongKey);
...
describe('File Encryption', () => {
  ...
  describe('File Encryption/Decryption', () => {
    test('should encrypt and decrypt files', async () => {
      ...
      const decryptResult = await FileEncryption.decryptFile(
        encryptResult.data!,
        testKey,
        itemId
      );
