    ...
    <div class="files-view">
        ...
        <div class="header-content">
          <div class="header-info">
            ...
            <p class="page-description">
              Securely store and manage your files with zero-knowledge encryption
            </p>
          </div>

          <div class="header-actions">
            <BaseButton variant="outline" @click="showUploadModal = true" icon="upload">
              Upload Files
            </BaseButton>
          </div>
        </div>
      ...
      >
        <div class="preview-container">
          <FilePreview :file="selectedFile" @preview-error="handlePreviewError" />

          <div class="preview-actions">
            <FileDownload :file="selectedFile" variant="outline"> Download </FileDownload>
            ...
            <BaseButton variant="ghost" @click="closePreview"> Close </BaseButton>
          </div>
        </div>
      </BaseModal>
...
const deleteSelectedFiles = async () => {
  ...
  const confirmed = confirm(
    `Are you sure you want to delete ${selectedFileIds.value.length} file(s)? This action cannot be undone.`
  );
  if (!confirmed) return;
