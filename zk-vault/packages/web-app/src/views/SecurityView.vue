...
.tab-button {
  @apply flex items-center space-x-2 px-6 py-4 text-sm font-medium text-neutral-600 hover:text-neutral-900 hover:bg-neutral-50 border-b-2 border-transparent transition-colors;
}
...
@media (prefers-color-scheme: dark) {
  ...
  .tab-button {
    @apply text-neutral-400 hover:text-neutral-100 hover:bg-neutral-700;
  }

  .tab-active {
    @apply text-primary-400 border-primary-400 bg-primary-900;
  }
}
</style>
