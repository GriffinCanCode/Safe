...
<style scoped>
.search-view {
  @apply space-y-8 max-w-7xl mx-auto px-4 py-6;
}
...
.section-title {
  @apply text-2xl font-semibold text-neutral-900 mb-6;
}
...
.quick-search-card {
  @apply bg-white border border-neutral-200 rounded-lg p-6 hover:border-primary-300;
  @apply hover:shadow-md transition-all cursor-pointer text-left;
}

.quick-search-icon {
  @apply w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mb-4;
...
.shortcut-button {
  @apply bg-white border border-neutral-200 rounded-lg p-4 hover:border-primary-300;
  @apply hover:shadow-sm transition-all cursor-pointer text-center space-y-2;
}

.shortcut-icon {
  @apply w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center mx-auto;
  @apply text-primary-600;
}
...
.recent-search-item {
  @apply flex items-center justify-between p-4 bg-white border border-neutral-200;
  @apply rounded-lg hover:border-primary-300 hover:shadow-sm transition-all cursor-pointer;
}
...
.filter-badge {
  @apply px-2 py-1 bg-primary-100 text-primary-700 rounded-full text-xs font-medium;
}
...
.tip-icon {
  @apply w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center mb-4;
  @apply text-primary-600;
}
...
.analytics-card {
  @apply bg-white border border-neutral-200 rounded-lg p-6 text-center;
}
