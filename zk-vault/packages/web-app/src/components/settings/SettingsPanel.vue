...
const currentSection = ref<
  'account' | 'security' | 'encryption' | 'backup' | 'appearance' | 'notifications'
>('account');
...
onMounted(() => {
  ...
  if (
    sectionFromQuery &&
    ['account', 'security', 'encryption', 'backup', 'appearance', 'notifications'].includes(
      sectionFromQuery
    )
  ) {
...
<!-- CSS classes are now defined in /styles/components/settings/settings-panel.css -->
