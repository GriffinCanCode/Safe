...
.requirement-icon {
  @apply w-4 text-center font-mono text-xs;
}
...
.detail-label {
  @apply block text-xs text-neutral-500 font-medium;
}

.detail-value {
  @apply block text-neutral-900 font-semibold;
}
...
.tip-icon {
  @apply w-4 h-4 text-info-600;
}

.tips-title {
  @apply text-sm font-medium text-info-800;
}
...
.tip-item {
  @apply text-sm text-info-700 list-disc;
}
...
.feedback-warning {
  @apply bg-warning-50 border border-warning-200 text-warning-700;
}

.feedback-info {
  @apply bg-info-50 border border-info-200 text-info-700;
}

.feedback-success {
  @apply bg-success-50 border border-success-200 text-success-700;
}
...
@media (prefers-color-scheme: dark) {
  ...
  .feedback-warning {
    @apply bg-warning-900 border-warning-700 text-warning-300;
  }
  
  .feedback-info {
    @apply bg-info-900 border-info-700 text-info-300;
  }
  
  .feedback-success {
    @apply bg-success-900 border-success-700 text-success-300;
  }
}
</style>
