...
<style scoped>
.password-editor {
  @apply bg-white rounded-lg shadow-lg max-w-2xl mx-auto;
}
...
.tags-input {
  @apply flex flex-wrap items-center gap-2 p-3 border border-neutral-300 rounded-lg;
  @apply focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-primary-500;
}
...
.tag-remove {
  @apply text-primary-600 hover:text-primary-800 font-bold;
}

.tag-input {
  @apply flex-1 min-w-0 border-0 outline-0 bg-transparent;
}
...
.editor-actions {
  @apply flex items-center justify-end gap-3 pt-6 border-t border-neutral-200;
}
