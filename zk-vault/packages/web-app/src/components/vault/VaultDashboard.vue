...
.dashboard-header {
  @apply flex items-start justify-between gap-6 flex-wrap;
}
...
.security-count {
  @apply px-2 py-1 bg-neutral-100 text-neutral-800 rounded-full text-sm font-medium;
}

.security-card.warning .security-count {
  @apply bg-yellow-200 text-yellow-800;
}

.security-card.danger .security-count {
...
.action-card {
  @apply bg-white rounded-lg p-6 shadow-sm border border-neutral-200;
  @apply hover:shadow-md hover:border-primary-300 transition-all;
  @apply text-left space-y-4 cursor-pointer;
}

.action-icon {
  @apply w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center;
  @apply text-primary-600;
}
