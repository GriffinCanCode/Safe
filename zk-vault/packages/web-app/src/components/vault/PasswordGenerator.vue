  ...
  <div class="password-generator">
    ...
    <div class="generator-options">
      ...
      <div class="option-group">
        <label class="option-label"> Length: {{ options.length }} </label>
        <input
      ...
      <div class="character-options">
        <div class="option-item">
          <label class="option-checkbox">
            <input v-model="options.includeUppercase" type="checkbox" @change="generatePassword" />
        ...
        <div class="option-item">
          <label class="option-checkbox">
            <input v-model="options.includeLowercase" type="checkbox" @change="generatePassword" />
        ...
        <div class="option-item">
          <label class="option-checkbox">
            <input v-model="options.includeNumbers" type="checkbox" @change="generatePassword" />
        ...
        <div class="option-item">
          <label class="option-checkbox">
            <input v-model="options.includeSymbols" type="checkbox" @change="generatePassword" />
        ...
        <div class="option-item">
          <label class="option-checkbox">
            <input v-model="options.excludeAmbiguous" type="checkbox" @change="generatePassword" />
    ...
    <div class="preset-section">
      ...
      <div class="preset-buttons">
        <BaseButton variant="outline" size="sm" @click="applyPreset('basic')"> Basic </BaseButton>
        <BaseButton variant="outline" size="sm" @click="applyPreset('strong')"> Strong </BaseButton>
        <BaseButton variant="outline" size="sm" @click="applyPreset('complex')">
          Complex
        </BaseButton>
        <BaseButton variant="outline" size="sm" @click="applyPreset('pin')"> PIN </BaseButton>
      </div>
    </div>
...
const buildCharacterPool = (): string => {
  ...
  if (options.excludeCharacters) {
    pool = pool
      .split('')
      .filter(char => !options.excludeCharacters.includes(char))
      .join('');
  }
