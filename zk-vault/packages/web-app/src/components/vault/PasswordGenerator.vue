...
<style scoped>
.password-generator {
  @apply w-full max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-lg;
}
...
.password-display {
  @apply space-y-4 mb-8 p-4 bg-neutral-50 rounded-lg;
}
...
.strength-metrics {
  @apply flex gap-4 text-xs text-neutral-500;
}
