        ...
        >
          ...
          <div v-if="$slots.header || title || closable" class="modal-header">
            <div class="modal-header-content">
              <slot name="header">
                <h3 v-if="title" :id="`${modalId}-title`" class="modal-title">
                  {{ title }}
                </h3>
              </slot>
            </div>
          ...
          <!-- Content -->
          <div :id="`${modalId}-content`" class="modal-content" :class="contentClasses">
            <slot />
          </div>
...
// Computed
const overlayClasses = computed(() => ['modal-overlay', props.overlayClass]);
...
const footerClasses = computed(() => ['modal-footer', props.footerClass]);
