  ...
  <div class="file-explorer">
    ...
    <div class="explorer-header">
      ...
      <div class="header-actions">
        ...
        <BaseButton variant="primary" @click="$emit('upload-files')" icon="upload">
          Upload Files
        </BaseButton>
      </div>
    </div>
    ...
    <div class="files-container">
      ...
      <div v-else-if="files.length === 0" class="empty-state">
        <div class="empty-icon">
          <svg class="h-16 w-16 text-neutral-400" fill="currentColor" viewBox="0 0 20 20">
            <path
              fill-rule="evenodd"
...
const getFileIcon = (_type: string): string => {
  // Return appropriate icon element type based on file type
  // For now, using a generic svg element as placeholder
  // TODO: Implement proper file type icons
  return 'div';
};
...
<!-- CSS classes are now defined in /styles/components/files/file-explorer.css -->
