<template>
  <div class="two-factor-setup">
        ...
        <div class="status-icon" :class="twoFactorEnabled ? 'enabled' : 'disabled'">
          <svg class="status-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              :d="twoFactorEnabled ? enabledIcon : disabledIcon"
            />
          </svg>
        </div>
    ...
    <div v-if="!twoFactorEnabled" class="setup-steps">
      ...
      <div v-if="currentStep === 'intro'" class="setup-step">
        ...
        <div class="step-actions">
          <BaseButton variant="primary" size="lg" @click="nextStep"> Continue Setup </BaseButton>
        </div>
      </div>
      ...
      <div v-if="currentStep === 'qr'" class="setup-step">
          ...
          <div class="qr-code-section">
            ...
            <div class="manual-entry">
              ...
              <p class="manual-instructions">
                Enter this secret key manually in your authenticator app if you can't scan the QR
                code.
              </p>
            </div>
          </div>
        ...
        <div class="step-actions">
          <BaseButton variant="outline" @click="previousStep"> Back </BaseButton>
          <BaseButton variant="primary" @click="nextStep"> I've Added the Account </BaseButton>
        </div>
      </div>
      ...
      <div v-if="currentStep === 'backup'" class="setup-step">
          ...
          <div class="backup-codes-section">
            <div class="backup-codes-warning">
              ...
              <div class="warning-content">
                ...
                <p class="warning-message">
                  ...
                  device. Store them in a safe place - they won't be shown again.
                </p>
              </div>
            </div>
            ...
            <div class="backup-codes">
              ...
              <div class="backup-codes-actions">
                <BaseButton variant="outline" @click="downloadBackupCodes">
                  Download Codes
                </BaseButton>
                <BaseButton variant="outline" @click="printBackupCodes"> Print Codes </BaseButton>
                <BaseButton
                  variant="outline"
        ...
        <div class="step-actions">
          <BaseButton variant="primary" size="lg" @click="completeSetup">
      ...
      <div class="management-grid">
        ...
        <div class="management-card">
          ...
          <div class="card-actions">
            <BaseButton variant="outline" size="sm" @click="showBackupCodes">
              View Codes
            </BaseButton>
            <BaseButton
              variant="outline"
        ...
        <div class="management-card">
          ...
          <div class="card-actions">
            <BaseButton variant="outline" size="sm" @click="testTwoFactor" :loading="testing">
              Test 2FA
            </BaseButton>
          </div>
        </div>
        ...
        <div class="management-card danger">
          ...
          <p class="card-description">
            Remove two-factor authentication from your account. This will make your account less
            secure.
          </p>
          <div class="card-actions">
            <BaseButton variant="danger" size="sm" @click="showDisableModal = true">
              Disable 2FA
            </BaseButton>
          </div>
        </div>
    ...
    <!-- Backup Codes Modal -->
    <BaseModal v-model="showBackupModal" title="Backup Codes" size="md">
      ...
      <template #footer>
        <BaseButton variant="outline" @click="showBackupModal = false"> Close </BaseButton>
        <BaseButton variant="primary" @click="downloadBackupCodes"> Download </BaseButton>
      </template>
    </BaseModal>

    <!-- Disable 2FA Modal -->
    <BaseModal v-model="showDisableModal" title="Disable Two-Factor Authentication" size="md">
      ...
      <template #footer>
        <BaseButton variant="outline" @click="showDisableModal = false"> Cancel </BaseButton>
        <BaseButton
          variant="danger"
    ...
    <!-- Test 2FA Modal -->
    <BaseModal v-model="showTestModal" title="Test Two-Factor Authentication" size="md">
      <div class="test-modal-content">
        <p class="test-description">
          Enter a code from your authenticator app to test that two-factor authentication is working
          correctly.
        </p>
      ...
      <template #footer>
        <BaseButton variant="outline" @click="showTestModal = false"> Close </BaseButton>
        <BaseButton
          variant="primary"
...
const backupCodesCount = computed(() => authStore.profile?.security.backupCodesCount ?? 0);

const enabledDate = computed(() => authStore.profile?.security.lastPasswordChange ?? new Date());
